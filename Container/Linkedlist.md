...
## <font  id="1">简介</font>
<font color="red">LinkedList</font>是一个实现了<font color="red" ><b>List接口</font>和<font color="red">Deque接口</font>的<font color="red">双端链表</font></b>。 
...
```
**区别：removeLast()在链表为空时将抛出NoSuchElementException，而pollLast()方法返回、null。**
